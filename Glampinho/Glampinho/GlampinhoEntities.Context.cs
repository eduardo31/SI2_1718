...
namespace Glampinho
{
    ...
    public partial class GlampinhoEntities : DbContext
    {
        ...
        public virtual int EnviarMailResponsaveis(Nullable<int> dias)
        {
            var diasParameter = dias.HasValue ?
                new ObjectParameter("dias", dias) :
                new ObjectParameter("dias", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("EnviarMailResponsaveis", diasParameter);
        }
    
        public virtual int InscreverUmHospedeNumaAtividade(string nIdentificacaoHospede, Nullable<int> numAtividade, Nullable<int> anoAtividade, Nullable<int> idEstada)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InscreverUmHospedeNumaAtividade", nIdentificacaoHospedeParameter, numAtividadeParameter, anoAtividadeParameter, idEstadaParameter);
        }
        ...
        public virtual int InsertAtividade(Nullable<int> num, Nullable<int> ano, string parque, string nome, string descricao, Nullable<int> lotacaoMaxima, Nullable<System.DateTime> dataRealizacao, Nullable<decimal> precoParticipante)
        {
            var numParameter = num.HasValue ?
                new ObjectParameter("num", num) :
                new ObjectParameter("num", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertAtividade", numParameter, anoParameter, parqueParameter, nomeParameter, descricaoParameter, lotacaoMaximaParameter, dataRealizacaoParameter, precoParticipanteParameter);
        }
        ...
        public virtual int InsertHospEstAti(string nIdentificacao, Nullable<int> num, Nullable<int> ano, Nullable<int> id)
        {
            var nIdentificacaoParameter = nIdentificacao != null ?
                new ObjectParameter("nIdentificacao", nIdentificacao) :
                new ObjectParameter("nIdentificacao", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertHospEstAti", nIdentificacaoParameter, numParameter, anoParameter, idParameter);
        }
